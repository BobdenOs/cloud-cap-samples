...
module.exports.__wbg_CQL_afc40a484b874958 = function(arg0, arg1) {
    const ret = CQL(getStringFromWasm0(arg0, arg1));
    return ret;
};
...
module.exports.__wbg_SELECT_6edcd2c98f3e142b = typeof SELECT == 'function' ? SELECT : notDefined('SELECT');
...
module.exports.__wbindgen_closure_wrapper84 = function(arg0, arg1, arg2) {
...
const path = require('path').join(__dirname, 'admin_service_bg.wasm');
